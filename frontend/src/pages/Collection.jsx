...
const Collection = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 pt-6 border-t border-gray-200 px-4 sm:px-8">
      {/* Filter options (Left Side) */}
      <div className="sm:min-w-[15rem]">
        <p
          onClick={() => setShowFilter(!showFilter)}
          className="my-2 text-lg sm:text-xl flex items-center cursor-pointer gap-2 font-medium"
        >
          FILTERS
          <img
        ...
        {/* Category */}
        <div
          className={`border border-gray-300 rounded-lg pl-4 py-3 mt-4 ${
            showFilter ? '' : 'hidden'
          } sm:block`}
        >
      ...
      <div className="flex-1">
        <div className="flex justify-between items-center mb-6">
          ...
          <select
            ...
            className="w-36 sm:w-36 border border-gray-300 text-sm px-1 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer"
          >
